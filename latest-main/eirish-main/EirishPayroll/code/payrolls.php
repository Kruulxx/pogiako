...
<body>
 ...
 <div class="border-bottom my-3"></div> 
            ...
            <a href="javascript:void(0);" class="btn btn-outline-warning" onclick="formToggle('importFrm');"><i class="plus"></i> Add Deduction</a>
            <a href="javascript:void(0);" class="btn btn-outline-secondary" onclick="formToggle('importFrm');"><i class="plus"></i> Print</a>
